...
# prepare colors
color_pal <- c(
  "#FFFFFF", "#4E1500", "#221B15", "#FFEC00", "#C79B00", "#0C0040",
...
count_table |>
  ...
  theme_minimal() +
  labs(
    title = "The Colors of 400+ Bob Ross Paintings",
    y = "Times Used",
    x = "",
    caption = caption
  ) +
  ...
  theme(
    axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1, family = "Patrick Hand", size = 35, color = "gray10"),
